...
DESCRIPTION = (
    ...
    "What it CANNOT do (constraints): it books nothing and takes no payment; it does not "
    "guarantee room/ticket availability or current prices; and it will not "
    "assert that a place is accessible without supporting "
